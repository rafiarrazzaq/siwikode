<section id="contact" class="contact section-bg" style="margin-top: 40px;">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      <h2>Registrasi Wisata Rekreasi</h2>
    </div>

    <div class="row">
      <div class="col-lg-12">
        <form action="<?= base_url("home/createWisataRekreasi") ?>" method="post" enctype="multipart/form-data" class="forminput">
          <div class="form-row">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" name="email" class="form-control" placeholder="Silahkan isi..." required>
            </div>
            <div class="form-group col-md-6">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="deskripsiWisata" rows="3" required></textarea>
          </div>

          <div class="form-group">
            <label for="name">Deskripsi Fasilitas</label>
            <textarea class="form-control" name="deskripsiFasilitas" rows="3" required></textarea>
          </div>

          <div class="form-group">
            <label for="name">Alamat Lengkap</label>
            <textarea class="form-control" name="alamatLengkap" rows="3" required></textarea>
          </div>
