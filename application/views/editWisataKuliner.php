<section id="contact" class="contact section-bg" style="margin-top: 40px;">
    <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
            <h2>Edit Wisata Kuliner</h2>
        </div>

        <div class="row">
            <div class="col-lg-12">
                <form action="<?= base_url("home/updateWisataKuliner") ?>" method="post" enctype="multipart/form-data" class="forminput">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="jenisWisata" class="form-control" style="border-radius: 0px; height: 44px;">
                                    ...
                                    <?php foreach ($jenisWisata as $row) { ?>
                                        <option value="<?= $row->id ?>" <?= $wisata->jenis_kuliner_id == $row->id ? "selected" : "" ?>><?= $row->nama ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
