                ...
                <?php foreach ($wisata as $row) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url("home/editWisataRekreasi/") . $row->id ?>" class="btn btn-warning px-3"><i class="fas fa-pencil-alt"></i></a>
                            <a href="<?= base_url("home/deleteWisataRekreasi/") . $row->id ?>" class="btn btn-danger px-3"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
